    ...
    <>
      ...
      <section className="relative overflow-hidden bg-beige">
        <div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 sm:px-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:py-28">
          <div className="animate-fadeUp">
            <p className="eyebrow">Aligned with ILO Convention 193, 2026</p>
            <h1 className="mt-4 text-4xl font-semibold leading-tight sm:text-5xl lg:text-6xl">
              Building Fairer Digital Workplaces
            </h1>
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-ink/70">
              A new international standard for platform work just arrived. VeriWork helps
              digital labour platforms assess, improve, and transparently demonstrate their
              alignment with it, before it becomes law where you operate.
            </p>
            <div className="mt-8 flex flex-wrap gap-4">
              <Link href="/assessment" className="btn-primary">
                Start Assessment <ArrowRight size={16} />
              </Link>
              <Link href="/convention-193" className="btn-secondary">
                What Convention 193 Means for You
              </Link>
            </div>
          </div>

          <div className="relative mx-auto flex h-72 w-72 items-center justify-center sm:h-96 sm:w-96">
            <div className="absolute inset-0 rounded-full bg-compass-ring opacity-90" />
            <div className="absolute inset-3 rounded-full bg-beige" />
      ...
      <section className="section grid gap-12 lg:grid-cols-[1fr_1fr]">
        <SectionHeading
          ...
          description="VeriWork gives digital labour platforms a practical way to prepare for ILO Convention 193 on Decent Work in the Platform Economy, through evidence-based self-assessment and real worker participation."
        />
      ...
      <section className="bg-forest text-beige">
        <div className="section">
          <SectionHeading
            eyebrow="Why Now"
            title="Convention 193 is new. Being ready for it early is an advantage."
            description="Conventions bind countries first, then become national law over time. Platforms that already meet the standard when that happens look prepared, not caught off guard."
            dark
          />
          ...
          <p className="mt-10 max-w-2xl text-sm leading-relaxed text-beige/70">
            ...
            practices against the new standard, giving workers a direct channel to be heard,
            and giving researchers, governments, and labour organizations real data to build
            informed policy from — something largely missing for this region until now.
          </p>
        </div>
      </section>
      ...
      <section className="bg-beige">
        <div className="section">
          <SectionHeading
            ...
            title="Seven pillars, built on ILO Convention 193"
            description="Every VeriWork assessment is structured around the same seven pillars, adapted directly from the ILO's international standard for platform work."
          />
      ...
      <section className="section grid gap-8 lg:grid-cols-2">
        <div className="card flex flex-col gap-5 bg-forest text-beige">
          ...
          <h3 className="text-2xl font-semibold text-beige">Get ahead of Convention 193, build worker trust.</h3>
          <ul className="space-y-2 text-sm text-beige/80">
            <li>Measure labour practices against the new international standard</li>
            <li>Receive improvement recommendations</li>
            <li>Track progress over time</li>
            <li>Build trust with workers and investors</li>
            <li>Show you were ready, before it was required</li>
          </ul>
      ...
      <section className="bg-forest">
        <div className="section flex flex-col items-center gap-8 text-center">
          ...
          <h2 className="max-w-2xl text-3xl font-semibold text-beige sm:text-4xl">
            Be Ready Before Convention 193 Becomes Law Where You Operate
          </h2>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/assessment" className="btn-primary bg-gold text-forest hover:bg-gold-light">
              Start Assessment
            </Link>
            <Link href="/convention-193" className="btn-secondary border-beige/30 text-beige hover:bg-beige/10">
              Learn About Convention 193
            </Link>
          </div>
        </div>
      </section>
